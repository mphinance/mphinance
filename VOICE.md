# Michael's Voice — Writing Style Guide

> The single source of truth for how Michael's content sounds and signs off.
> If you only read one thing before writing as Michael, read this. Then read SUBSTACK.md for the publishing mechanics.

---

## The One Rule That Gets Broken Most

**The sign-off is exactly this, on its own line, nothing else:**

```
~ Michael
```

Tilde, space, first name. That is the whole signature.

- **Never** a last name. Not in the signature, not in a byline, not in the subtitle, not in passing, not anywhere a reader can see. First name only, every time.
...
Two named registers he'll ask for by shorthand:
- **"Wit"** = witty, lighter, more jokes (Sanderson's Wit).
- **"Vin"** = blunt, stripped down, no filler (Sanderson's Vin).
...
- **Bold the numbers.** Readers skim. Make the skim land on the real figure.
- **Closing CTA.** Always a subscribe nudge, never desperate, usually tied back to the lesson.

---

## Skin in the Game (the differentiator)

Half of Substack revenue gets reinvested into the exact names he writes about, in his real IBKR and tastytrade accounts. That is the thing that separates him from grifters: he eats his own cooking, with receipts. Lead with this whenever the paid model is questioned.
...
- **Surface a parabolic / already-run name as if it's a fresh setup.** Only actionable pullbacks, reversals, and fresh breakouts. Cut the editorializing.
- **Jargon without an immediate plain-English gloss.** If your wife reads it and asks if she's having a stroke, rewrite it.
...
- Stocks get personalities: "PLUMPY" for Plume, "the copper-plated compounder" for MLI.
- Recovery / AA woven in as trading-discipline metaphor. Natural, never preachy.
- "Your trades deserve more precision than your marriages" energy.

---

## Cross-Community Habit

He embeds "go read this writer" links to other Substack authors inside posts to farm reciprocal restacks. When it fits, name a fellow writer and link them.
...
> "Earnings are seriously mostly bullshit. They're a suggestion. A narrative."
> "Everyone's worried AI will ruin our personal relationships. Looking at my own track record, maybe 'human' isn't the gold standard we think it is."
> "Financial statements aren't the most fun thing to read, so I thought I'd use real revenue to show how companies actually build them."

---

## Example Sign-Off

Every piece ends, on its own line:

```
~ Michael
```

That's it. That's the whole signature.
