TITLE: Stop Vibing Your AI Voice File. Measure It. (Write Better With AI)
SUBTITLE: AI 50% | Mindset 35% | Business 15%
AUDIENCE: everyone

Someone I ran into Thursday told me he'd given up on getting AI to sound like him. He'd written one of the voice files I’ve mentioned. Quick recap - mine’s a file that says "I'm witty and direct and I hate corporate speak," and then the model reads it and writes like a LinkedIn post wearing a leather jacket.

So he decided voice files don't work. I get it. Mine didn't work either for a long time. But just like humans, you’ve got to have this file evolve with you, and keep learning.

You can't write a voice file. You have to catch one.

- 
- 
[caption] Example of what my AI reads about meA3. Self-corrects mid-sentence. Will not let a clean-but-false line stand. This is the densest tell. He dulls his own sentence rather than overclaim. The detector under-counts this one (R3 fires 0/6 in the rule matrix because the regex only catches parenthetical hedges; many real self-corrections are bare clauses like “and I couldn’t find it” or “she’s getting upgraded everyday”).
...
I wrote mine that way first. Here's the original if you want to point and laugh: VOICE.md. It's not bad. It's just a description of a person, and a description is not a fingerprint.
...
What I cut matters as much as what I add. I cut the windup line, the one that announces what I'm about to say before I say it. I cut the doubled metaphor and keep one. I cut the AA-meeting jargon but keep the wisdom underneath it. Those cuts are me. A model that only learns what I add learns half a person.
...
The whole rulebook is here, with the real before-and-after for every rule: VOICE-DELTA.md. I open-sourced it. It costs me nothing and it might save you a month.
...
It’s definitely not perfect yet, as it loves to call me out when I miss one of my own edit rules, such as “Here’s the Truth”

[caption] I made a rule to remove all “Here is the truth” and missed one myself. Work in progress
...
The full scorecard and the code that generates it: ACCURACY.md and the harness itself. It all shipped Friday in pull request #61 if you want to see how the sausage gets made.
