...
Hi! I'm a super legit "not financial advice" disclaimer that you've read so you're not going to sue me now. I am a trader, not your financial advisor. Past screener performance does not guarantee future picks. Good talk.
...
I heard something awhile back, I believe my my uncle, that sounds too simple to be useful. Every day, it gets a little easier. But you gotta do it every day. That is the hard part.
...
Last night I looked at the four screeners that run every morning inside the Ghost Alpha pipeline and realized something uncomfortable. They were working, but they were lazy. They were simple pass/fail filters.
...
That was most of the screeners in the Ghost Alpha pipeline. Four of them. Running since January. They were picking decent setups, but they lacked nuance. They settled for "good enough" instead of hunting for the absolute best.
