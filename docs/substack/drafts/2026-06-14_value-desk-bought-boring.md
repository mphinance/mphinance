...
![A trillion-dollar rocket on one side, a pallet of decking and a sack of corn starch on the other.](value_desk_hero.png)
...
![Where the institutional dollars actually went the week of the SpaceX IPO. The hype on one side, the boring value buys on the other.](value_desk_receipts.png)
