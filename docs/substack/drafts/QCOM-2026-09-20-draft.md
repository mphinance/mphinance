---
title: "Amazon and I Own Qualcomm From the Same Price (Seven Cents Apart)"
subtitle: "Trading 60% | Options 30% | Mindset 10%"
audience: only_paid
---
...
Seven cents. Amazon and I are long the same stock from the same price. One of us negotiated it (well, its lawyers did), and one of us bought it in lots of ten coming off a $142 low because he liked the chart. I'll let you guess which.
...
One caveat: it's a snapshot, not a live feed. Open interest moves and the levels move with it. The file was generated this morning, so it's a map dated today.
...
The technicals, quickly, so a TA person can double check me: RSI rolled from 68.7 to 54.4. ADX is 22.9, no trend, just chop. It knifed through the 8 EMA and is holding above the 21. The 200-day is at **$166.99**, and the option chain has one real support strike, **$160**, right under my basis and Amazon's.

That shelf is the whole reason I'm not panicking. Amazon's strike, my cost, the 200-day and the put wall are stacked inside a $7 window. I don't get to claim I planned that.
...
Now the warrants. **25 million shares at $161.26**, around $4 billion of stock, on 1.068 billion outstanding. That's **2.34%** dilution. Say it plainly: Qualcomm is paying a customer in equity to be a customer.

The margin math, on the page, because it's what the headline hides. FY25 revenue was **$44.3B** at a **54.2%** gross margin. Data-center silicon runs in the 30s to low 40s. Blend $15B of 35%-margin revenue onto that base:

(44.3 × 0.542 + 15 × 0.35) ÷ (44.3 + 15) = **49.3%**

Revenue up 34%, gross profit up 22%, five points of margin gone. That's what the escape from smartphones costs. A fine trade to make. A trade, not a gift.
...
My only quarrel is with "cushion." A 0.17 delta is roughly a one-in-six event. That's a moat until it isn't. And their framing assumes you own none of it. I own 70, which changes the answer completely.
...
On the gamma flip: three models gave me three numbers today, because they look at different windows. The flip sits somewhere in the low $150s to low $160s depending on how far out you look. Don't let anyone sell you a decimal on it, me included.
...
Step one: R is what you lose if you're wrong. Entry $176.36, stop $167.39, so **R = $8.97** per share. That's exactly one ATR, on purpose: the stop sits one average day's range under the entry band.

Step two: R picks your share count, not your gut.

Shares = (account × risk %) ÷ R

At 1% risk: ($100,000 × 0.01) ÷ $8.97 = **111 shares**, a **$19,576** position.
...
Step three is where it clicks. Score each target in R, then ask what win rate it needs just to break even.

$180 is 0.41R. To break even you have to be right **71.1%** of the time. Forever.

$190 is 1.52R. Break-even win rate: **39.7%**.

$200 is 2.64R. 27.5%, but you have to actually get there.

Step four, the two numbers you know before you click. At 111 shares: **+$1,514** if $190 hits, **−$996** if the stop does. One trade can't hurt you.
...
Door A is going to 100. Buy 30 at Friday's close, $5,331.60. New basis $166.25. Sell the October $190 call for **$477.50** and the break-even drops to $161.47. If it's called away, **+$2,852.80**, or 17.2%, in 26 days, with about a one-in-three chance of that happening.

I'm not doing it, and I'm putting that in print so I can't quietly change my mind. Adding 30 shares to a name that just got rejected on 3x volume is the exact move I'd tell you not to make. Pretty math is not a reason.

Door B is the wheel newsletter's trade: sell the $160 put, collect $230.50 against $16,000 of collateral, 1.44% for the month. If assigned you own 170 shares at $159.19, and 70 of them still don't fit a contract. Same room, different door.

Door C is sit. 70 shares, up 10%, zero income, waiting.

I'm on C. Not because it's smart. Because A means adding into weakness and B means owning 170 of a stock I have 70 of by accident. I buy in tens because it feels like less commitment, which is the same bullsh*t logic that has me paying for three streaming services I don't watch. But I digress. Buy in lots of 100 or don't pretend you're wheeling it. I made that mistake in August and I'm living in it now.
