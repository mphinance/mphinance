...
2. **NVDA** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/NVDA/deep_dive.html) : *Everyone knows they sell shovels in the AI gold rush, but their real moat is CUDA—they've locked developers into a software ecosystem that competitors can't easily break.*

3. **AVGO** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/AVGO/deep_dive.html) : *The undisputed king of custom networking silicon. As hyperscalers desperately try to reduce reliance on NVIDIA, Broadcom is the one building their custom ASICs.*

4. **MU** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/MU/deep_dive.html) : *AI servers require exponentially more memory than traditional servers. Micron is the bottleneck and the toll collector for High Bandwidth Memory (HBM).*

5. **GLXY** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/GLXY/deep_dive.html) : *Mike Novogratz's crypto merchant bank. It trades at a massive discount to its NAV because it's on the TSX, making it a backdoor, leveraged play on Bitcoin and digital assets.*

6. **TSM** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/TSM/deep_dive.html) : *The geopolitical chokepoint of the modern world. Without Taiwan Semi, the global tech industry grinds to a halt. They are the only foundry that can manufacture what Apple and NVIDIA design.*
...
10. **GOOGL** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/GOOGL/deep_dive.html) : *The market priced them for death by ChatGPT, completely ignoring that they own the world's most ubiquitous operating system (Android) and the second largest search engine (YouTube).*

11. **ASTS** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/ASTS/deep_dive.html) : *Building cell towers in space. They have the first-mover advantage, orbital patents, and backing from AT&T. If the tech scales globally, the TAM is borderline unquantifiable.*

12. **RKLB** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/RKLB/deep_dive.html) : *The only viable competitor to SpaceX. Their Neutron rocket is specifically designed to deploy mega-constellations, positioning them to break Musk's monopoly on orbital delivery.*

13. **ONDS** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/ONDS/deep_dive.html) : *A massive sleeper in industrial drone automation. Their Scout system doesn't just fly; it acts as a fully autonomous security and inspection network for critical infrastructure.*

14. **NBIS** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/NBIS/deep_dive.html) : *The European response to AI infrastructure. Led by Yandex's ex-CEO, they are quietly building one of the most powerful and energy-efficient AI compute clusters in the world.*

15. **UAMY** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/UAMY/deep_dive.html) : *A crucial domestic supply chain play. Antimony is a critical mineral for military munitions and batteries, and China controls the supply. UAMY is the US counter-move.*
...
1. **LUNR** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/LUNR/deep_dive.html) : *They didn't just land on the moon; they are positioning to be the FedEx of cislunar space logistics, establishing the first permanent lunar infrastructure for NASA.*

2. **SMR** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/SMR/deep_dive.html) : *The only company with a fully NRC-certified Small Modular Reactor design. As AI data centers drain the grid, SMRs are the only scalable, clean baseload power solution.*

3. **UMAC** - [Deep Dive](https://mphinance.github.io/mphinance/docs/ticker/UMAC/deep_dive.html) : *A direct beneficiary of the Pentagon's push for domestic drone components. They are building the US-based supply chain for FPV drones to replace Chinese DJI dominance.*
