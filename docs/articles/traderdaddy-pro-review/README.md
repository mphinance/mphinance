...
*Disclosure, since most of you know already: I build for [TraderDaddy Pro](https://www.traderdaddy.pro/?ref=8DUEMWAJ). The screeners, a chunk of the engine. The link is my referral link. So don't take my word for it. Take theirs.*
...
![TraderDaddy Pro's live institutional flow detection: sector heat and the most-watched tickers](dashboard.png)
...
![The Elite Momentum Pullback screener: trend filter, pullback trigger, entry and score](screener.png)

**Unusual Activity.** Filter to +5M premium, unusual only, +80 score. The difference between seeing flow and using it.

![The Unusual Activity feed: flow type, sentiment, strike, expiry, premium, volume, and score on every line](unusual-activity.png)
...
![GEX calculator: spot vs. gamma flip, total GEX, max gamma strike, and the GEX-by-strike chart](gex.png)
...
**[See what they're talking about → traderdaddy.pro](https://www.traderdaddy.pro/?ref=8DUEMWAJ)**
